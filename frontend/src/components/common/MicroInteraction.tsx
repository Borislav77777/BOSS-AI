...
export const MicroInteraction: React.FC<MicroInteractionProps> = memo(({
    children,
    variant = 'ripple',
    intensity = 'medium',
    duration = 0.3,
            ...
            <AnimatePresence>
                {showTooltip && tooltip && (
                    <motion.div
                        ...
                        className={cn(
                            'absolute z-[9999999] px-2 py-1 text-xs text-white bg-neutral-800 rounded shadow-lg whitespace-nowrap',
                            getTooltipPosition()
                        )}
                    >
                        {tooltip}
...
export const useMicroInteraction = (
    _variant: MicroInteractionProps['variant'] = 'ripple',
    intensity: MicroInteractionProps['intensity'] = 'medium'
) => {
