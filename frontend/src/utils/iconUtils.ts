 ...
 */
export const getCategoryIcon = (categoryId: string): LucideIconType => {
 ...
 * @returns Lucide иконка
 */
export const getMessageIcon = (sender: string): LucideIconType => {
    const iconMap: Record<string, LucideIconType> = {
 ...
 * @returns Lucide иконка
 */
export const getItemIconType = (type: string): LucideIconType => {
    const iconMap: Record<string, LucideIconType> = {
 ...
 * @returns Lucide иконка
 */
export const getActionIcon = (action: string): LucideIconType => {
    const iconMap: Record<string, LucideIconType> = {
 ...
 * @returns Lucide иконка
 */
export const getStatusIcon = (status: string): LucideIconType => {
    const iconMap: Record<string, LucideIconType> = {
