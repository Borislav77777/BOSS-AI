...
export class AccentColorApplier {
     ...
     */
    static applyDarkAccent(state) {
        const root = document.documentElement;
        let accentColor;
        // Базовый акцент для темной темы — БЕЛЫЙ
        const isDefaultState = state.darkAccentHue === 0 && state.lightAccentHue === 0 &&
     ...
     */
    static applyCustomAccent(state) {
        const root = document.documentElement;
        let accentColor;
...
//# sourceMappingURL=AccentColorApplier.js.map