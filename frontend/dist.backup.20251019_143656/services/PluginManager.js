...
export class PluginManager {
    constructor() {
        ...
        this.UPDATE_CHECK_INTERVAL = 24 * 60 * 60 * 1000; // 24 часа
        this.PLUGINS_STORAGE_KEY = 'barsukov_plugins';
        this.PLUGIN_REGISTRY_URL = '/api/plugins/registry.json';
     ...
     */
    async loadPluginManifest(pluginUrl) {
     ...
     */
    async loadPluginConfig(pluginUrl) {
     ...
     */
    validatePluginCompatibility(_manifest) {
     ...
     */
    async checkPluginDependencies(manifest) {
