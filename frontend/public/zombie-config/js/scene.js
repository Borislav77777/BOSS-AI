...
class BossAIScene {
     ...
     */
    dispose() {
        console.log('[BossAIScene] Disposing scene resources...');
        ...
        console.log('[BossAIScene] Scene disposed successfully');
    }
}
...
// Экспорт в window для использования в React
window.BossAIScene = BossAIScene;
